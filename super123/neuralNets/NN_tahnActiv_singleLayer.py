...
def neural_tahn_1layer():
    ...
    neuralNet_tahn1 = MLPRegressor(hidden_layer_sizes = (40, 50), activation = 'tanh', max_iter=2000)
    neuralNet_tahn1.fit(train_X, train_y)

    return neuralNet_tahn1