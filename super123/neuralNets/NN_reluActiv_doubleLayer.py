...
def neural_relu_2layer():
    ...
    neuralNet_relu2 = MLPRegressor(hidden_layer_sizes = (40, 50), activation = 'relu', max_iter=2000)
    neuralNet_relu2.fit(train_X, train_y)

    return neuralNet_relu2
