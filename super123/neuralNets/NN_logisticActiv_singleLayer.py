...
def neural_logistic_1layer(): 
    ...
    neuralNet_logistic = MLPRegressor(hidden_layer_sizes = 90, activation = 'logistic', max_iter=2000)
    neuralNet_logistic.fit(train_X, train_y)
    
    return neuralNet_logistic