...
def neural_relu_1layer():
    ...
    neuralNet_relu1 = MLPRegressor(hidden_layer_sizes = (40, 50), activation = 'relu', max_iter=2000)
    neuralNet_relu1.fit(train_X, train_y)

    return neuralNet_relu1
